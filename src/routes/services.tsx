...
import { ArrowRight, Home, Building2, Factory, Wrench, Wallet, Sun } from "lucide-react";
...
export const Route = createFileRoute("/services")({
  ...
  head: () => ({
    meta: [
      { title: "Services | RK Solar Green Mount" },
      { name: "description", content: "Residential, commercial, industrial solar — plus financing, O&M and PM Surya Ghar subsidy assistance." },
    ],
  }),
});

const icons: Record<string, typeof Home> = {
  residential: Home, commercial: Building2, industrial: Factory,
  maintenance: Wrench, financing: Wallet, "pm-surya-ghar": Sun,
};
