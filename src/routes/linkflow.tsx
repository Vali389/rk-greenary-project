...
import BoomerangVideoBg from '@/components/site/BoomerangVideoBg';

export const Route = createFileRoute('/linkflow')({
  component: LinkFlowPage,
  head: () => ({
    meta: [
      { title: "LinkFlow™ — Close the rift linking signals and action" },
      { name: "description", content: "Shape scattered signals into meaningful outcomes via AI-driven workflows." },
    ],
  }),
});
...
function LinkFlowPage() {
  ...
  return (
    <section 
      className="relative w-full min-h-screen sm:h-screen overflow-hidden bg-white"
      style={{ fontFamily: "'Neue Haas Grotesk Display Pro 55 Roman', 'Neue Haas Grotesk Text Pro', 'Helvetica Neue', Helvetica, Arial, sans-serif" }}
    >
